...
def build_dataloader(args):
    ...
    if args.dataset == 'imagenet':
        ...
        train_transforms_l, train_transforms_r = transform.build_train_transforms(args.aa, args.color_jitter, args.reprob, args.remode, args.interpolation)
        train_dataset = TinyImageNetDataset(os.path.join(args.data_path, 'train'), os.path.join(args.data_path, 'meta/train.pickle'), transform=train_transforms_l)
    elif args.dataset == 'cifar10':
    ...
    if args.dataset == 'imagenet':
        ...
        val_transforms_l, val_transforms_r = transform.build_val_transforms(args.interpolation)
        val_dataset = TinyImageNetDataset(os.path.join(args.data_path, 'val'), os.path.join(args.data_path, 'meta/val.pickle'), transform=val_transforms_l)
    elif args.dataset == 'cifar10':
